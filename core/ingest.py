...
from core.sources import crossref, europepmc, openalex, resolvers
...
def _paper_id(source, record, doi):
    if doi:
        normalized = R.normalize_title(doi)
    elif record.get("openalex_id"):
        normalized = R.normalize_title(record["openalex_id"])
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--source", default="openalex,europepmc,crossref")
